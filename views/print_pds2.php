...
<table id="t01" class="centerTable">
					...
					<tr class="text-center">
					 ...
					 <?php 
						...
						$num_rows_vols = mysqli_num_rows($vols);
					
						while($vol = $vols->fetch_assoc()){
					?>
					 <tr>
                        <td colspan="6"><b><?php echo $vol['name_address'] ?></b></td>
                        <td colspan="1"><b><?php $vol['voluntary_from'];
                        ...
                        ?></b></td> 
                       <td colspan="1"><b><?php $vol['voluntary_to'];
					...
					<?php 
					for( $num_rows_vols>=0; $num_rows_vols <=10; $num_rows_vols++ ){
					?>
					...
					$num_rows_trains = mysqli_num_rows($trains);
					...
					<tr>
                        <td colspan="6"><b><?php echo $train['title'] ?></b></td>
                          ...
                          <td colspan="1"><b><?php $train['att_from'];
                        ...
                        ?></b></td> 
                          ...
                          <td colspan="1"><b><?php $train['att_to'];
					...
					<?php 
					for( $num_rows_trains>=0; $num_rows_trains <=33; $num_rows_trains++ ){
					?>
