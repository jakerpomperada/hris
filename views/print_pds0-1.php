...
<style type="text/css">
    ...
    <body>
        ...
        <table id="t01" class="centerTable" style="padding: 10px;">
         <tr>
          <td colspan="12" class="bot">
            <i class="eleven"><b>CS Form No. 212</b></i><br><i class="nine"><b>Revised 2017</b></i>
        </td>
    </tr>
    <tr>
      <td colspan="12" class="bot">
       <font class="header"><b><center style="margin-bottom: 11px;">PERSONAL DATA SHEET </center></b></font>
   </td>
</tr>
<tr>
    <td colspan="12" class="bot nopadding"><i><b>WARNING: Any misrepresentation main in the Personal Data Sheet and the
        Work Experience Sheet shall cause the filing of administative/criminal case/s
    against the person concerned.</b></i></td>
</tr>
<tr>
    <td colspan="12" class="bot nopadding"><i><b>READ THE ATTACHED GUIDE TO FILLING OUT THE PERSONAL DATA SHEET (PDS)
    BEFORE ACCOMPLISHING THE PDS FORM</b></i></td>
</tr>
<tr>
    <td colspan="9" class="nopadding" style="font-size: 13px;">Print legibly. Tick appropriate boxes ( <input type="checkbox" checked> ) ad use
        seperate sheet if necessary. Indicate N/A if not applicable. <b>DO NOT ABBREVIATE.</b></td>
        <td colspan="1" style="border:1px solid #000b;width:8%;" class="col-color"><small>1. CS ID
        No.</small></td>
        <td colspan="2" class="text-right" style="border:1px solid #000;width:20%;"><small>(Do not fill
        up. For CSC use only)</small></td>
    </tr>
    <tr>
        <td colspan="12" class="text-white separator cat-head">I. PERSONAL INFORMATION</td>
    </tr>
    <tr>
...
<tr>
    ...
    <td colspan="5" rowspan="2"><b><?php $date_birth; 
    ...
    <td colspan="3" rowspan="4" class="s-label align-top border-bottom-0 left-head" style="vertical-align: top; padding-top: 10px;">
        ...
        If holder of dual citizenship,<br><br> please indicate the
    details.
    </td>
    ...
    <td colspan="3" rowspan="2" class="bot">
        ...
        <div for="my-input" class="text-center" style="margin-top: 10px;">Pls. indicate country:</div>
    </td>
</tr>
<tr>
</tr>
...
<tr>
    <td colspan="1" rowspan="2" class="s-label border-bottom-0 left-head"><span class="count">6.</span> CIVIL STATUS</td>
...
<tr>
    <td colspan="12" class="text-white separator cat-head">II. FAMILY BACKGROUND</td>
</tr>
<tr>
    ...
    <td colspan="3" class="s-label text-center left-head" style="width: 18%;">DATE OF BIRTH (mm/dd/yyyy)</td>
</tr>
<tr>
...
<tr>
    <td colspan="12" class="text-white separator cat-head">III. EDUCATIONAL BACKGROUND</td>
</tr>
<tr class="text-center">
    ...
    <td colspan="4" rowspan="2" class="s-label border-bottom-0 left-head">
        NAME OF SCHOOL<br>(Write in full)
    </td>
    <td colspan="2" rowspan="2" class="left-head">
        BASIC EDUCATION/DEGREE/COURSE<br>
        (Write in full)
    </td>
    <td colspan="2" class="s-label border-bottom-0 left-head">
        PERIOD OF ATTENDANCE
    </td>
    <td colspan="1" rowspan="2" class="s-label border-bottom-0 left-head"> HIGHEST LEVEL / UNITS EARNED<br>(If not graduated)
    </td>
    <td colspan="1" rowspan="2" class="s-label border-bottom-0 left-head">YEAR GRADUATED</td>
    <td colspan="1" rowspan="2" class="s-label border-bottom-0 left-head">SCHOLARSHIP/<br>ACADEMIC<br>HONORS<br>RECEIVED
    </td>
</tr>
<tr class="text-center" style="margin-top: -20px; height: 20px">
    <td colspan="1" width="100px" height="50px" class="s-label left-head">From</td>
    <td colspan="1" width="100px" height="50px" class="s-label left-head">To</td>
</tr>
<?php
...
<tr>
    <td colspan="1" class="text-center sig"><i><b>SIGNATURE</b></i></td>
    <td colspan="6"></td>
